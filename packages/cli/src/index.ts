...
async function runSubmit(argv: string[]) {
  ...
  const raw = interactionFile === "-"
    ? await readAllFromStdin()
    : await readFile(interactionFile, "utf8");
